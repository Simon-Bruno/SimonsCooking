...
def login():
    ...
    return render_template("login.html", form=login_form, logged_in=current_user.is_authenticated, year=year)
...
def show_post(post_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
    return render_template("post.html", post=requested_post, logged_in=current_user.is_authenticated, form=form, current_user=current_user, year=year)
